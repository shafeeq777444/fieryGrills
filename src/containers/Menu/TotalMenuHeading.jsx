        ...
        <div className="min-h-screen bg-white text-slate-800">
            ...
            {/* <div className="flex flex-col md:flex-row items-center justify-between px-8 py-16 max-w-6xl mx-auto">
                <div className="md:w-1/2 mb-10 md:mb-0">
                    <h1 className="text-5xl font-bold text-red-800 mb-4">Fiery Grills Punjabi Tiffin</h1>
            ...
            <AnimatedOnScroll><VgAndNonvgMenuSections
...
<AnimatedOnScroll><VgAndNonvgMenuSections
            ...
            {/* Salads Section */}
            <AnimatedOnScroll> <MenuGridSection
