...
const AnimatedButton = () => {
  return (
    <button
      className="group relative inline-flex items-center gap-3 rounded-full scale-75 bg-[#89151E] px-4 py-3 hover:scale-80 font-semibold text-white transition-all duration-300 hover:bg-red-800"
    >
      Call Now
